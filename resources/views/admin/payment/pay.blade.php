                        ...
                        <div class="checkout-details">
                            <div class="order-box">
                                ...
                                <form action="{{ route('admin.payment.success', $booking->id) }}" method="POST">
                                    ...
                                    @method('patch')
                                    <ul class="qty">
                                        <li>Room: <span class="badge badge-primary"
                                                style="font-size: 13px; color: #ffffff;"><b>{{ $booking->room->name }}</b></span>
                                        </li>
                                        <li>Room Category: <span class="badge badge-success"
                                                style="font-size: 13px; color: #ffffff;"><b>{{ $booking->room->category->name }}</b></span>
                                        </li>
                                        @php
                                        ...
                                        @endphp
                                        <li>Length Of Stay: <span class="badge badge-danger"
                                                style="font-size: 13px; color: #ffffff;"><b>{{ $day }} @if ($day == 1) Day @else Days @endif</b></span></li>
                                        <li>Check in: <span class="badge badge-light"
                                                style="font-size: 10.5px; color: #000000;">{{ $booking->check_in }}</span>
                                        </li>
                                        <li>Check out: <span class="badge badge-light"
                                                style="font-size: 10.5px; color: #000000;">{{ $booking->check_out }}</span>
                                        </li>
                                    </ul>
                                    <ul class="sub-total">
                                        <li>
                                            <p style="font-size: 15px;">Subtotal</p> <input type="number"
                                                value="{{ $price }}" readonly class="form-control" required
                                                id="total">
                                        </li>
                                    </ul>
                                    <ul class="sub-total total">
                                        <li style="font-size: 14px;">Money: <input type="number" class="form-control"
                                                required id="money"></li>
                                        <li style="font-size: 14px;">Return: <input type="number" value="0" readonly
                                                class="form-control" required id="return"></li>
                                    </ul>
