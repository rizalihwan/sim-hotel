@extends('layouts.app', ['title' => 'HRI-HOTEL | Admin Account'])
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                      <a href="{{ route('admin.account.editadmin', $account->id) }}" style="float: left;" class="mr-1"><i class="fa fa-pencil-square-o" style="color: rgb(0, 241, 12);"></i></a>
