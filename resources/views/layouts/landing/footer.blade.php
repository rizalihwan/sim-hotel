...
<div class="text-center copyright">HRI HOTEL 2021</div>
...
<script src="{{ asset('landing/assets/jquery.js') }}"></script>

<!-- wow script -->
<script src="{{ asset('landing/assets/wow/wow.min.js') }}"></script>
...
<!-- boostrap -->
<script src="{{ asset('landing/assets/bootstrap/js/bootstrap.js') }}" type="text/javascript"></script>

<!-- jquery mobile -->
<script src="{{ asset('landing/assets/mobile/touchSwipe.min.js') }}"></script>

<!-- jquery mobile -->
<script src="{{ asset('landing/assets/respond/respond.js') }}"></script>

<!-- gallery -->
<script src="{{ asset('landing/assets/gallery/jquery.blueimp-gallery.min.js') }}"></script>
