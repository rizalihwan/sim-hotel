            ...
            <ul class="sidebar-links custom-scrollbar">
                <li class="back-btn">
                    <a href="javascript:void(0)"><img class="img-fluid"
                            src="{{ asset('assets/images/logo/logowebdark.png') }}" alt=""></a>
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                        href="{{ route('admin.room.index') }}"><i data-feather="wind">
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                        ...
                        </i><span>Booking</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                        href="{{ route('admin.customer.index') }}"><i data-feather="user">
                        </i><span>Customer</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                        href="{{ route('admin.payment.index') }}"><i data-feather="activity">
