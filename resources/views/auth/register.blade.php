                        ...
                        <div class="login-main">
                            <form class="theme-form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="logo"><img class="img-fluid for-light"
                                        ...
                                        style="height: 100px; width: 300px; object-fit: cover;"><img
                                        class="img-fluid for-dark" src="{{ asset('assets/images/logo/logowebdark.png') }}"
                                        alt="looginpage" style="height: 100px; width: 300px; object-fit: cover;"></div>
